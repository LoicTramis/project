        ...
        if (isset($_GET['answer2']) && $_GET['answer2'] == "true")
            ...
            if (isset($_GET['answer3']) && $_GET['answer3'] == "true")
                ...
                if (isset($_GET['answer4']) && $_GET['answer4'] == "true")
                    ...
                    $insert_question = "INSERT INTO Question (type_question,text_question,difficulte,id_theme) VALUES ('".$type_question."','".$text_question."','".$niveau."','".$id_theme."') RETURNING id_question";
